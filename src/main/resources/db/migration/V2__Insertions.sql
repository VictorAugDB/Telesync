...
insert into tminutos_telefone values (1, "30", "40", "0");
insert into tminutos_telefone values (2, "60", "60", "1");
insert into tminutos_telefone values (3, "120", "90", "1");

insert into tplano (`nomePlano`, `valorPlano`, `cicloDias`, `codTipoPlano`, `codPacInternet`, `codPacMinutos`) values("Pré-pago 60 minutos", "60", "30", "0", "0", "2");
insert into tplano (`nomePlano`, `valorPlano`, `cicloDias`, `codTipoPlano`, `codPacInternet`, `codPacMinutos`) values("Pré-pago 120 minutos", "90", "30", "0", "0", "3");
insert into tplano (`nomePlano`, `valorPlano`, `cicloDias`, `codTipoPlano`, `codPacInternet`, `codPacMinutos`) values("Pós-pago 60 minutos", "70", "30", "0", "0", "2");
insert into tplano (`nomePlano`, `valorPlano`, `cicloDias`, `codTipoPlano`, `codPacInternet`, `codPacMinutos`) values("Pós-pago 120 minutos", "100", "30", "0", "0", "3");
insert into tplano (`nomePlano`, `valorPlano`, `cicloDias`, `codTipoPlano`, `codPacInternet`, `codPacMinutos`) values("Controle 30 minutos", "40", "30", "0", "0", "1");
insert into tplano (`nomePlano`, `valorPlano`, `cicloDias`, `codTipoPlano`, `codPacInternet`, `codPacMinutos`) values("Controle 60 minutos", "70", "30", "0", "0", "2");
insert into tplano (`nomePlano`, `valorPlano`, `cicloDias`, `codTipoPlano`, `codPacInternet`, `codPacMinutos`) values("Internet 1 gb ", "30", "30", "0", "1", "0");
